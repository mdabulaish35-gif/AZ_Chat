/* eslint-disable */
// ^^^ YE LINE BAHUT ZAROORI HAI: Ye saare Red Errors ko gayab kar degi

import React, { useEffect, useRef, useState } from "react";
import io from "socket.io-client";

// --- 1. CRASH GUARD (Polyfills) ---
// Ye code check karta hai ki browser environment ready hai ya nahi
...
function App() {
    ...
    const handleDragStart = () => {
        if (isOneOnOne) setIsDragging(true);
    };
            ...
            {!joined ? (
                <div style={styles.loginContainer}>
                    <div style={styles.loginCard}>
                        ...
                        <h2 style={{ color: "white", marginTop: "0", marginBottom: "30px" }}>Join Meeting</h2>
                        <input
                            type="text"
                            name="room" // Fix for Form ID warning
